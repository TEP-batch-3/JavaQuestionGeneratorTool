...
<div class="form-group row" id="lev1" style="display: none;margin-left: 34%;width: 49%;">
	 <div class="col-sm-2"></div>
	  <div class="col-sm-6"></div>
       <div class="col-sm-6">
        <input type="text" id="op1" class="btn btn-default btn-sm dropdown-toggle form-control" data-toggle="dropdown" value="" ><span class="caret"></span>
    		...
    		try{
    			...
    			l1 = 0;
    			 while(rs.next())
					...
					%>
					<label for="<%=title %>">
					<a href="#" class="small" data-value="<%=title %>" tabIndex="-1"><input type="checkbox" name="level1Operations" id="opselect1" value="<%=title %>"/>&nbsp;<%=title %>"</a> <br>
                  </label>
					<%
				l1++;
					}
...
<div class="form-group row" id="lev2" style="display: none;margin-left: 34%;width: 49%;">
	 <div class="col-sm-2"></div>
	  <div class="col-sm-6"></div>
       <div class="col-sm-6">
        <input type="text" id="op2" class="btn btn-default btn-sm dropdown-toggle form-control" data-toggle="dropdown" value="" ><span class="caret"></span>
    		...
    		try{
    			...
    			l2 = 0;
    			 while(rs.next())
					...
					%>
					<label for="<%=title %>">
					<a href="#" class="small" data-value="<%=title %>" tabIndex="-1"><input type="checkbox" name="level2Operations" id="opselect2" value="<%=title %>"/>&nbsp;<%=title %>"</a> <br>
                  </label>
					<%
				l2++;
					}
